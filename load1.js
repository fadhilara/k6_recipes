...
export const options = {
  ...
  thresholds: {
    http_req_failed: ['rate<0.02'], // the error rate must be lower than 0.02%
    http_req_duration: ['p(90)<300'], // 90% of requests must complete below 300ms
    http_req_receiving: ['max<25'], // slowest request below 25ms
    iteration_duration: ['p(95)<1600'], // 95% of requests must complete below 1600ms
   },
   cloud: {
    // Project: recipes
    projectID: 3767840,
